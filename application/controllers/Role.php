...
class Role extends CI_Controller {
	...
	public function index()
	{
		...
		$data['role']           	= $this->main->get_data('tbl_role');
    ...
    public function role_access($id_roles){
        $id_role 					= $this->session->userdata('id_role');
		$data['menu'] 				= $this->main->get_menu_selected($id_role); 
        $data['sub_menu'] 		    = $this->main->get_data('tbl_sub_menu');
		$where 				        = ['id_role' => $id_roles];
        $data['role']               = $this->db->get_where('tbl_role',['id_role'=>$id_roles])->row_array();
	...
	public function edit_data($id_roles){
		$id_role 					= $this->session->userdata('id_role');
		$data['menu'] 				= $this->main->get_menu_selected($id_role); 
		$where 				        = ['id_role' => $id_roles];
