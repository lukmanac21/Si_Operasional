    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="card-header">
            <h3 class="card-title">Ubah Data Master Sub Menu</h3>
          </div>
            <div class="card-body">
            <?php foreach($sub_menu as $row_sub_menu){?>
              <form class="form-horizontal" role="form" action="<?= site_url('Submenu/update_data');?>" method="post">
                  <div class="card-body">
                  ...
                  <div class="form-group row">
                      <label class="col-sm-1 col-form-label">Nama Sub Menu</label>
                      <div class="col-sm-11">
