    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="card-header">
            <h3 class="card-title">Tambah Data Master Menu</h3>
          </div>
            <div class="card-body">
              <form class="form-horizontal" role="form" action="<?= site_url('menu/save_data');?>" method="post">
                  ...
                  <div class="form-group row">
                      <label class="col-sm-1 col-form-label">Icon Menu</label>
                      <div class="col-sm-11">
                      <input type="text" class="form-control" name="icon_menu" placeholder="Icon Menu" required>
                      </div>
                  </div>
                  </div>
                  <!-- /.card-body -->
