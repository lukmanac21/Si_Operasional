    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="card-header">
            <h3 class="card-title">Tambah Data Master Anggaran</h3>
          </div>
            <div class="card-body">
              <form class="form-horizontal" role="form" action="<?= site_url('anggaran/save_data');?>" method="post">
                  <div class="card-body">
                  ...
                  <div class="form-group row">
                      ...
                      <option value="<?= $row_sub_rekening->id_sub_rek?>"><?=$row_sub_rekening->uraian_rekening." ". $row_sub_rekening->uraian_sub_rek?></option>
                        <?php } ?>
                        </select>
                  </div>
                  <div class="form-group row">
                      <label class="col-form-label">Anggaran</label>
                      <input type="number" class="form-control" name="anggaran" placeholder="Anggaran" required>
                  </div>
                  </div>
                  <!-- /.card-body -->
