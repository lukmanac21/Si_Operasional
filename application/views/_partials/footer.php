...
<script>
   $(document).on('change', 'select[name=id_sub_rek]', function(e){
      ...
      //  var realisasisebelum = $('option:selected', this).attr('realisasisebelum');
       $('input[name=anggaran]').val(anggaran);
       
      //  $('input[name=realisasisebelum]').val(realisasisebelum);
      //  $('input[name=sisaanggaran]').val(anggaran-realisasisebelum);
   });
  //  $("#rekening").change(function () {
       
  //       var rekening = $("#rekening").val();
  //       var global_url = '<?php echo site_url('Pencairandana/getData/'); ?>' + rekening;
  //       //alert(global_url);
  //       if(rekening != 0){
...
<script>
        $('.form-check-input').on('click',function(){
            ...
            $.ajax({
                url: "<?= site_url('Role/change_access');?>",
                type:  "post",
                data: {
                    menuId : menuId,
                    roleId : roleId
                ...
                success : function(){
                    document.location.href = "<?= site_url('Role/role_access/'); ?>" + roleId;
                    }
                });
            });
    </script>
