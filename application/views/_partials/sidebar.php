<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="<?= site_url('Dashboard/index');?>" class="brand-link">
      <img src="<?= base_url();?>assets/img/logo/si-maya.jpg" class="brand-image img-circle elevation-3"
           style="opacity: .8">
      <span class="brand-text font-weight-light">SI-Operasional</span>
    </a>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview ">
            ...
            <?php 
              ...
              $querySub = "SELECT * FROM tbl_sub_menu inner join tbl_user_access on tbl_user_access.id_sub_menu = tbl_sub_menu.id_sub_menu where tbl_sub_menu.id_menu = $menuId and tbl_user_access.id_role = $roleId ORDER BY tbl_sub_menu.nama_sub_menu ASC" ;
