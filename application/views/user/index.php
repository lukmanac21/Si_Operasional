        ...
        <div class="card">
          ...
          <div class="card-body">
            <table id="example1" class="table table-bordered table-striped">
              <button type="button" class="btn btn-primary" onclick="window.location.href='<?= site_url();?>/User/add_data';">Tambah</button>
              <br>
                <br>
              <thead>
              <tr>
              ...
              <tbody>
                <?php foreach($user as $row_user){?>
                    <tr>
                        ...
                        <td style="text-align:center;"><a style="color:white;" type="button" href="<?= site_url('User/edit_data/').$row_user->id_user ;?>" class="btn btn-info" > Ubah</a</td>
